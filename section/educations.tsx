...
export function EducationsSection() {
  return (
    <section id="education" className="bg-muted/5 py-8">
                ...
                >
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      <div className="mt-2 flex flex-wrap items-center text-muted-foreground gap-2">
                        <div className="mr-4 flex items-center">
                          <School className="mr-1 h-4 w-4 text-primary" />
                    ...
                    {(edu.achievements ?? []).length > 0 && (
                      <div className="mt-5 border-t border-border/100 pt-2">
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-border/100 pt-2">
                      ...
                      {edu.documents != null && edu.documents?.length > 0 && (
                        <Button
                          variant="ghost"
                          size="sm"
